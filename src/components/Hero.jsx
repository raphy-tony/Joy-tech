...
import { discount, laptop, robot } from "../assets";
        ...
        >
          <motion.div className="flex flex-row items-center py-[6px] px-4 bg-discount-gradient rounded-[10px] mb-2">
            ...
            <p className={`${styles.paragraph} ml-2`}>
              <span className="text-white"></span> Travel consultantion Services from the most trusted Agency{" "}
            </p>
          </motion.div>
          ...
          <motion.div className="flex flex-row justify-between items-center w-full">
            <motion.h1 className="flex-1 font-poppins font-semibold ss:text-[72px] text-[52px] text-white ss:leading-[100.8px] leading-[75px]">
              ...
              <span className="flex-1 font-poppins font-semibold ss:text-[72px] text-[52px] text-white ss:leading-[100.8px] leading-[75px]">and</span>{" "}
            </motion.h1>
          </motion.div>
